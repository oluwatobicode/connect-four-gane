...
const Modal = () => {
  const { toggleMenu, leaveCurrentGame, playAgain, state } = useGameContext();
  const navigate = useNavigate();

  const handleClickOutSide = () => {
    if (state.isGameActive) toggleMenu();
  };
  ...
  return (
    ...
    >
      <div
        ...
        className="md:bg-[#7945FF] bg-[#7945FF] rounded-[40px] border-4 border-black shadow-[0px_8px_0px_#000000] md:rounded-[40px] md:border-4 flex flex-col items-center justify-center md:border-black md:w-[480px] md:h-[491px] w-[335px] h-[437px] mx-auto md:shadow-[0px_8px_0px_#000000]"
      >
        ...
        {state.gameMode !== "PVP" && (
          ...
          >
            <span className="text-center w-full">PLAY AGAIN</span>
          </button>
        )}
